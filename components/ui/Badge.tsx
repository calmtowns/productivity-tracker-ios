...
export default function Badge({ variant = 'normal', children, className }: BadgeProps) {
  return (
    <span className={cn('inline-flex items-center gap-0.5 px-2 py-0.5 rounded-full text-[11px] font-medium', MAP[variant], className)}>
      {children}
    </span>
  )
}
