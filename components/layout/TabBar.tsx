            ...
            >
              {isActive && (
                <motion.div
                  ...
                  className="absolute inset-x-3 top-0 h-0.5 bg-amber-700 dark:bg-amber-500 rounded-full"
              ...
              <Icon
                ...
                className={cn(
                  ...
                  isActive ? 'text-amber-800 dark:text-amber-400' : 'text-stone-400 dark:text-stone-600'
                )}
              />
              <span className={cn(
